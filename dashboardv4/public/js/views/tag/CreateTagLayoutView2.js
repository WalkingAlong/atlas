...
define(['require',
    'backbone',
    'hbs!tmpl/tag/CreateTagLayoutView_tmpl2',
    'utils/Utils',
    ...
    var CreateTagLayoutView = Backbone.Marionette.CompositeView.extend(
        /** @lends CreateTagLayoutView */
        {
            ...
            /** ui selector cache */
            ui: {
                tagName: "[data-id='tagName2']",
                parentTag: "[data-id='parentTagList2']",
                description: "[data-id='description2']",
                title: "[data-id='title2']",
                attributeData: "[data-id='attributeData2']",
                addAttributeDiv: "[data-id='addAttributeDiv2']",
                createTagForm: '[data-id="createTagForm2"]'
            },
            /** ui events hash */
            events: function() {
                var events = {};
