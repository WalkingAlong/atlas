...
define(["require", "backbone", "utils/Globals", "hbs!tmpl/enum/SearchDefaultLayoutView_tmpl", 'utils/Utils', 'utils/CommonViewFunction', 'utils/Enums'], function(require, Backbone, Globals, SearchDefaultLayoutViewTmpl, Utils, CommonViewFunction, Enums) {
    "use strict";
    ...
    var SearchDefaultlLayoutView = Backbone.Marionette.LayoutView.extend(
        /** @lends SearchDefaultlLayoutView */
        {
            ...
            renderSearchResult: function() {
                var that = this;
                require(["views/enum/SearchResultLayoutView"], function(SearchResultLayoutView) {
